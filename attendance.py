...
class Attendance:
    def __init__(self, root, fname):
       ...
       # Techno logo
        ...
        self.AttendanceReport_table = ttk.Treeview(table_frame, column=("slno", "student_id", "rollno", "name",
                                                                         "department", "semester","faculty_name", 
                                                                         "subject_name", "date", "time", "attendance"),
    ...
    def mark_attendance(self, i, r, n, d, s):
        with open("Attendance.csv","r+", newline="\n") as f:
            ...
            if((i not in name_list) and (r not in name_list) and (n not in name_list) 
               and (d not in name_list) and (s not in name_list)):
                now =  datetime.now()
