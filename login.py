...
class Login_Window:
    def __init__(self, root):
        ...
        self.show_pass_checkbtn = Checkbutton(frame, text="Show Password", variable=self.show_pass_var, 
    ...
    def forgot_pass(self):
        if self.txtuser.get()=="":
            ...
            if row == None:
                ...
                self.show_pass_var = IntVar()
                self.show_pass_checkbtn = Checkbutton(self.root2, text="Show Password", variable=self.show_pass_var, 
                ...
                reset_btn = Button(self.root2, text="Reset", font=("times new roman", 14), command=self.reset_pass,
                                   bg="green", fg="white")
...
class Register:
    def __init__(self, root):
        ...
        # ============ Show / Hide Password =============
        self.show_pass_checkbtn = Checkbutton(frame, text="Show Password", variable=self.var_showpass, 
        ...
        # =========== Check Box ============
        self.checkBtn = Checkbutton(frame, variable=self.var_check, 
                                    text="I Agree to the Terms & Conditions", font=("times new roman", 10,"bold"),
                               bg="lightblue", onvalue=1, offvalue=0, activebackground="black")
        self.checkBtn.place(x=30, y=415)

        # ========= Register Button ==========
        registerBtn = Button(frame, text="Register",font=("times new roman",14,"bold"),command=self.register_data, 
        ...
        # ========= Login Button ==========
        loginBtn = Button(frame, text="Login", font=("times new roman", 14, "bold"), command=self.return_login, 
